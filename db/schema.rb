...
ActiveRecord::Schema.define(version: 2019_04_26_080447) do
  ...
  create_table "alternate_server_translations", force: :cascade do |t|
  ...
  create_table "alternate_servers", force: :cascade do |t|
    t.string "url"
  ...
  create_table "article_images", id: :string, limit: 32, force: :cascade do |t|
    t.string "source_url"
  ...
  create_table "articles", id: :string, limit: 32, force: :cascade do |t|
    t.string "name", null: false
    t.integer "article_source_id", null: false
    t.integer "creator_id"
    t.datetime "created_at", null: false
  ...
  create_table "locations", id: :string, limit: 32, force: :cascade do |t|
    t.string "name", null: false
    t.integer "creator_id", null: false
    t.integer "modifier_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "product_entries", id: :string, limit: 32, force: :cascade do |t|
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.binary "username", limit: 255, default: "x''", null: false
    t.datetime "deleted_at"
