...
ActiveRecord::Schema.define(version: 2019_04_26_080447) do
  ...
  create_table "article_images", id: :string, limit: 32, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "source_url"
    t.string "original_basename"
    t.string "original_extname"
    t.string "mime_type"
    t.binary "image_data"
    t.string "article_id", limit: 32, null: false
  ...
  create_table "articles", id: :string, limit: 32, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "barcode"
    t.string "name", null: false
    t.integer "article_source_id", null: false
    t.integer "creator_id"
  ...
  create_table "locations", id: :string, limit: 32, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", null: false
    t.integer "creator_id", null: false
    t.integer "modifier_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "product_entries", id: :string, limit: 32, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
