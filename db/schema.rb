...
ActiveRecord::Schema.define(version: 2019_04_26_080447) do
  ...
  create_table "alternate_server_translations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
  ...
  create_table "alternate_servers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    t.string "url"
  ...
  create_table "application_settings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    t.string "setting_key", null: false
    t.string "setting_value", null: false
  end

  create_table "article_images", id: :string, limit: 36, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    t.string "source_url"
  ...
  create_table "article_sources", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
  ...
  create_table "articles", id: :string, limit: 36, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    t.string "barcode"
    t.string "name", null: false
    t.integer "article_source_id", null: false
    t.integer "creator_id"
  ...
  create_table "impressions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
  ...
  create_table "locations", id: :string, limit: 36, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    t.string "name", null: false
    t.integer "creator_id", null: false
    t.integer "modifier_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "locations_users", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
  ...
  create_table "producers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    t.string "name"
    t.integer "creator_id"
    t.integer "modifier_id"
    t.datetime "created_at"
  ...
  create_table "product_entries", id: :string, limit: 36, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
