...
ActiveRecord::Schema.define(version: 2018_10_11_144846) do
  ...
  create_table "article_images", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "source_url"
  ...
  create_table "product_entries", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
